...
namespace MathPlugin
{
    public class Add
    {
        ...
        // Must manually add the OpenApiParameter and OpenApiResponseWithBody attributes
        // Description fields for parameters and operations are critical: They are used 
        // by Planner to determine which function to call
